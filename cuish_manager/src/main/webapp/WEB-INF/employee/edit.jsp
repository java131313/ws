...
<body>
	...
	<div id="m" class="easyui-window" title="Window Layout" closed="true" data-options="iconCls:'icon-save'" style="width:500px;height:500px;padding:5px;">
		<div style="width:400px;padding:20px;margin:20px">
			<form action=""  id="fmm">
				<table cellpadding="5">
					...
					<tr>
						<td class="tt">性别：</td>
						<td><input id="postCode" class="easyui-textbox" name="sex" style="width:200px"></td>
					</tr>
					<tr>
						<td class="tt">生日：</td>
					...
					<tr>
						<td class="tt">机构号：</td>
						<td>
							<input class="easyui-textbox"name="orgId" style="width:200px;" 
							data-options="
									valueField:'id',
									textField:'name',
		...
		<div id="dlg-buttons">
        <a href="javascript:void(0)" class="easyui-linkbutton " iconCls="icon-ok" onclick="edit()" style="width:50px">Save</a>
        <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel" onclick="javascript:$('#m').dialog('close')" style="width:50px">Cancel</a>
    </div>
	</div>
</body>
</html>