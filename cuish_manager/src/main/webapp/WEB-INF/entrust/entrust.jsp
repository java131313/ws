	...
	<div class="easyui-layout" data-options="fit:true">
				<div data-options="region:'north',split:true,border:false" style="height:50px">
					<div style="margin-left:50px">
						...
						<a href="javascript:modifyWindow(${pos.id})" class="easyui-linkbutton" data-options="iconCls:'icon-cut'">修改</a> 
					...
					<div>
						...
						<thead>
							<tr>
								...
								<th data-options="field:'name',width:30">委托方名称</th> 
								<th data-options="field:'parentId',width:120">委托方简码</th>
								<th data-options="field:'orderNo',width:120">委托方联系地址</th>
								<th data-options="field:'description',width:120">委托方客服热线</th>
								<th data-options="field:'path',width:120">委托方对接人</th>
